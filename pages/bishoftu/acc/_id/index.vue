<template>
  <div>
    ...
    <section class="s__acc__hero">
      <div class="container1">
        <div class="hero-title">
          ...
          <a @click.prevent="$router.go(-1)" class="text back">
            <img src="@/assets/img/icons/next2.svg" alt="" />
            back to accomodations
          </a>
        </div>

        <HeroSlide :img="renderdData.slides" :subTitle="renderdData.title" />

        <div class="container">
          <Desc1 :desc="renderdData.desc" />

          <h1 class="title center am">amenities</h1>
        </div>
      </div>
    </section>
    ...
    <section class="amenities">
      <div class="container">
        <ul class="first">
          <li class="text" v-for="text in renderdData.amenities" :key="text">
            {{ text }}
          </li>
        </ul>

        <ul class="second">
          <li class="text" v-for="text in renderdData.amenities1" :key="text">
            {{ text }}
          </li>
        </ul>

        <ul class="third">
          <li class="text" v-for="text in renderdData.amenities2" :key="text">
            {{ text }}
          </li>
        </ul>
      </div>
...
<script>
import OtherAcc from "../../../../components/OtherAcc.vue";
export default {
  components: { OtherAcc },
  data() {
    return {
      ...
      accData: [
        {
          ...
          title: "lake view",
          slides: [
            "bishoftu/acc/lakeview/1.webp",
            "bishoftu/acc/lakeview/2.webp",
            "bishoftu/acc/lakeview/3.webp",
            "bishoftu/acc/lakeview/4.webp",
            "bishoftu/acc/lakeview/5.webp",
          ],
          desc: [
            {
              id: 1,
        ...
        },
        {
          ...
          title: "Garden View",
          slides: [
            "bishoftu/acc/gardenView/1.webp",
            "bishoftu/acc/gardenView/2.webp",
            "bishoftu/acc/gardenView/3.webp",
            "bishoftu/acc/gardenView/4.webp",
            "bishoftu/acc/gardenView/5.webp",
          ],
          desc: [
            {
              id: 1,
        ...
        },
        {
          ...
          title: "Loft Village",
          slides: [
            "bishoftu/acc/loft/1.webp",
            "bishoftu/acc/loft/2.webp",
            "bishoftu/acc/loft/3.webp",
            "bishoftu/acc/loft/4.webp",
            "bishoftu/acc/loft/5.webp",
            "bishoftu/acc/loft/6.webp",
            "bishoftu/acc/loft/7.webp",
            "bishoftu/acc/loft/8.webp",
          ],
          desc: [
            {
              id: 1,
